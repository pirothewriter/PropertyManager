		...
		<div id="seacher" class="form-group">
			<span>
				<form class="form-inline" name="searcher">
					<label>부서명(大)</label> <select class="form-control" id="selectUpper"
						name="upperDivision">
						<option value=''>부서명(大)</option>
						<c:forEach var="category" items="${upperDivisions }"
							varStatus="status">
							<option value="${category.categoryName }">${category.categoryName }</option>
						</c:forEach>
					</select> <label>부서명(小)</label> <select id="selectLower"
						class="form-control" name="lowerDivision">
						<option value=''>부서명(小)</option>
					</select> <label>AD 계정</label> <input class="form-control" name="adAccout"
						id="searchAdAccout"> <label>사원명</label><input
						class="form-control" name="nameOfMember" id="searchName">
