...
public class CsvWriterService {
    ...
    public String generateCsvFile(int nth, String adAccount, String memberName, String flagDifference) throws IOException {
		...
		CSVWriter csvWriter = new CSVWriter(new OutputStreamWriter(new FileOutputStream(propertyFile), "EUC-KR"), ',', '"');
